							...
							<div class="trip-search">
								<form class="form">
									...
									<div class="form-group">
										<div class="nice-select form-control wide" tabindex="0"><span class="current"><img src="<?php bloginfo('template_url') ?>/images/destination-icon.png" alt="#">Destination</span>
											<ul class="list">
									...
									<!-- Form Activities -->
									<div class="form-group">
										<div class="nice-select form-control wide" tabindex="0"><span class="current"><img src="<?php bloginfo('template_url') ?>/images/activities-icon.png" alt="#">Activities</span>
											<ul class="list">
									...
									<div class="form-group duration">
										<div class="nice-select form-control wide" tabindex="0"><span class="current"><img src="<?php bloginfo('template_url') ?>/images/duration-icon.png" alt="#">Duration</span>
											<ul class="list">
									...
									<!-- Form Budget -->
									<div class="form-group">
										<div class="nice-select form-control wide" tabindex="0"><span class="current"><img src="<?php bloginfo('template_url') ?>/images/budget-icon.png" alt="#">Budget</span>
											<ul class="list">
					...
					<div class="row no-gutters">
						<div class="col-lg-6 col-md-6 col-12">
							...
							<div class="single-service">
								<img src="<?php bloginfo('template_url') ?>/images/service-icon1.png" alt="#">
						...
						<div class="col-lg-6 col-md-6 col-12">
							<!-- single service -->
							<div class="single-service">
								<img src="<?php bloginfo('template_url')?>/images/service-icon2.png" alt="#">
						...
						<div class="col-lg-6 col-md-6 col-12">
							<!-- single service -->
							<div class="single-service">
								<img src="<?php bloginfo('template_url') ?>/images/service-icon3.png" alt="#">
						...
						<div class="col-lg-6 col-md-6 col-12">
							<!-- single service -->
							<div class="single-service">
								<img src="<?php bloginfo('template_url') ?>/images/service-icon4.png" alt="#">
								<h2>Outdoor Tour</h2>
								<p>Lorem ipsum dolor sit amet, consectetur iscing elit. Etiam fermentum</p>
								<a href="service-single.html" class="btn">Read More</a>
							</div>
